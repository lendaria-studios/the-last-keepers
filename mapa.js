export default class mapa extends Phaser.Scene {
  ...
  preload () {
    ...
    this.load.image('sombras-arvore', 'assets/mapa/sombras-arvore.png')
  ...
  create () {
    ...
    this.tilesetGrama = this.tilemapMapa.addTilesetImage('chao')
    ...
    this.tilesetPlantas = this.tilemapMapa.addTilesetImage('arvore')
    this.tilesetSombrasPlantas = this.tilemapMapa.addTilesetImage('sombras-arvore')
    ...
    this.anims.create({
      key: 'parado',
      frames: [{ key: 'personagem', frame: 80 }],
      frameRate: 1
    })

    this.anims.create({
      key: 'andar-direita',
      frames: this.anims.generateFrameNumbers('personagem', { start: 91, end: 96 }),
      frameRate: 10,
      repeat: -1
    })
